...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderBody" Runat="Server">
    ...
    <div class="row">
            ...
            <h3><a href="Samples.aspx" class="btn btn-md btn-danger"><i class="fa fa-chevron-left"></i></a>&nbsp;Print Known File Formats without displaying any Print dialog! <small>(if needed)</small></h3>
            <p>

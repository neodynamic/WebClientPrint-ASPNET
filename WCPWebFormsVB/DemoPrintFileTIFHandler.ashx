<%@ WebHandler Language="VB" Class="DemoPrintFileTIFHandler" %>
...
Public Class DemoPrintFileTIFHandler : Implements IHttpHandler
    ...
    Public Sub ProcessRequest(ByVal context As HttpContext) Implements IHttpHandler.ProcessRequest
        ...
        If WebClientPrint.ProcessPrintJob(context.Request.Url.Query) Then
            ...
            Dim file As New PrintFileTIF(context.Server.MapPath(filePath), fileName)

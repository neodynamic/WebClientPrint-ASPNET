...
<div class="container">
    <div class="row">
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("Index", "DemoPrintCommands")"><i class="icon fa fa-barcode"></i>&nbsp;Raw Data Printing</a>
            </h2>
            <p>
        ...
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("Index", "DemoPrintFile")"><i class="icon fa fa-file-text-o"></i>&nbsp;Print Files</a>
            </h2>
            <p>
        ...
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("PrintersInfo", "Home")"><i class="icon fa fa-print"></i>&nbsp;Printers Info</a>
            </h2>
            <p>
    ...
    <div class="row">
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("Index", "DemoPrintFilePDF")"><i class="icon fa fa-file-pdf-o"></i>&nbsp;Advanced PDF Printing</a>
            </h2>
            <p>
        ...
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("Index", "DemoPrintFileDOC")"><i class="icon fa fa-file-word-o"></i>&nbsp;Advanced DOC Printing</a>
            </h2>
            <p>
        ...
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("Index", "DemoPrintFileXLS")"><i class="icon fa fa-file-excel-o"></i>&nbsp;Advanced XLS Printing</a>
            </h2>
            <p>
    ...
    <div class="row">
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("Index", "DemoPrintFileTIF")"><i class="icon fa fa-files-o"></i>&nbsp;Advanced TIF Printing</a>
            </h2>
            <p>
        ...
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("Index", "DemoPrintFileWithEncryption")"><i class="icon fa fa-lock"></i>&nbsp;Print Files With Encryption</a>
            </h2>
            <p>
        ...
        <div class="col-sm-4">
            <h2>
                <a href="@Url.Action("Index", "DemoPrintFileWithPwdProtection")"><i class="icon fa fa-key"></i>&nbsp;Print Files With Password Protection</a>
            </h2>
            <p>
